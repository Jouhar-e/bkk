         ...
         <div class="lg:col-span-3">
             ...
             <div class="mt-12">
                 ...
                 <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                     <!-- Related Article 1 -->
                     <div
                         class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-all duration-300">
                         <span
                             class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 mb-3">
                             Lowongan Kerja
                         </span>
                         <h3 class="text-lg font-semibold text-gray-900 mb-2 hover:text-blue-700 transition-colors">
                             <a href="#">

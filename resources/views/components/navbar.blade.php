        ...
        <div class="flex justify-between items-center py-3">
            ...
            <div class="hidden lg:flex items-center space-x-8 mr-8">
                ...
                <div class="dropdown relative group">
                    ...
                    <!-- Dropdown Items -->
                    <div class="dropdown-menu absolute hidden group-hover:block bg-white shadow-xl rounded-md mt-2 py-2 w-48 z-50 border border-blue-100 right-0 transition duration-300">
                        <a href="#"
            ...
            <div class="flex items-center lg:hidden">
                <button class="text-blue-200 text-lg p-2 rounded-full hover:bg-blue-800 transition duration-300" id="mobile-menu-button">
    ...
    <div class="lg:hidden bg-blue-900 border-t border-blue-700 py-3 hidden" id="mobile-menu">
        <div class="container mx-auto px-4 space-y-1">
            ...
            <div class="border-b border-blue-700">
                <button class="flex justify-between items-center w-full py-3 px-4 font-medium text-sm text-white mobile-dropdown-toggle">
                ...
                <div class="pl-10 mt-1 hidden mobile-dropdown-content space-y-2 pb-2">
                    <a href="#" class="block py-2 text-xs 
